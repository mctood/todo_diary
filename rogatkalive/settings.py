"""
Django settings for rogatkalive project.
...
SECRET_KEY = 'django-insecure-9gow6_k*kch-cooeff(ml+sfk=bd-nb4dj9i&rdbbv9mjw652^'
...
WSGI_APPLICATION = 'rogatkalive.wsgi.application'
...
AUTH_USER_MODEL = 'rogatkalive.User'